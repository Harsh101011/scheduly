...
const experts = [
  ...
  },
  {
    ...
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=emily&backgroundColor=d1f4d1',
    hourlyRate: 180,
    availableSlots: generateSlots(BASE_DATE),
  },
  {
    ...
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=jennifer&backgroundColor=ffdfbf',
    hourlyRate: 120,
    availableSlots: generateSlots(BASE_DATE),
  },
  {
